...
using DatePickerTest.ViewModel;
...
namespace DatePickerTest
{
    ...
    public partial class App : Application
    {
        ...
        private static CountViewModel cviewModel;
        public static CountViewModel CViewModel
        {
            get { return cviewModel; }
        }

        public static int selectedIndex = -1;
        private static ClockViewModel clviewModel;

        public static ClockViewModel ClViewModel
        {
            get { return clviewModel; }
        }

        private static DiaryViewModel dviewModel;
        public static DiaryViewModel DViewModel
        {
            get { return dviewModel; }
        }
